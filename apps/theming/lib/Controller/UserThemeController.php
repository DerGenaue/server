...
class UserThemeController extends OCSController {
	 ...
	 *
	 * @return JSONResponse<ThemingBackground, Http::STATUS_OK>
	 */
	 ...
	 * @return JSONResponse<ThemingBackground, Http::STATUS_OK>|JSONResponse<array{error: string}, Http::STATUS_BAD_REQUEST|Http::STATUS_INTERNAL_SERVER_ERROR>
	 *

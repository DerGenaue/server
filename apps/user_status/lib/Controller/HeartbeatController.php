...
class HeartbeatController extends OCSController {
	 ...
	 *
	 * @return DataResponse<UserStatusPrivate, Http::STATUS_OK>|DataResponse<\stdClass::class, Http::STATUS_BAD_REQUEST|Http::STATUS_INTERNAL_SERVER_ERROR|Http::STATUS_NO_CONTENT>

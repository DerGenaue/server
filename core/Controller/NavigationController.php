...
class NavigationController extends OCSController {
	 ...
	 * @return DataResponse<CoreNavigationEntry[], Http::STATUS_OK>|DataResponse<\stdClass::class, Http::STATUS_NOT_MODIFIED>
	 *
	...
	public function getAppsNavigation(bool $absolute = false): DataResponse {
		...
		if ($this->request->getHeader('If-None-Match') === $etag) {
			return new DataResponse(\stdClass::class, Http::STATUS_NOT_MODIFIED);
		}

...
class WhatsNewController extends OCSController {
	 ...
	 * Get the changes
	 *
	 * @return DataResponse<array{changelogURL: string, product: string, version: string, whatsNew: array{regular: string[], admin: string[]}}, Http::STATUS_OK>|DataResponse<\stdClass::class, Http::STATUS_NO_CONTENT>
	 *
	...
	public function get():DataResponse {
		...
		if (version_compare($lastRead, $currentVersion, '>=')) {
			return new DataResponse(\stdClass::class, Http::STATUS_NO_CONTENT);
		}
	 ...
	 *
	 * @return DataResponse<\stdClass::class, Http::STATUS_OK>

...
class UnifiedSearchController extends OCSController {
	 ...
	 * @return DataResponse<CoreUnifiedSearchProvider[], Http::STATUS_OK>
	 */
	 ...
	 *
	 * @return DataResponse<CoreUnifiedSearchResult, Http::STATUS_OK>|DataResponse<\stdClass::class, Http::STATUS_BAD_REQUEST>
	 *
